...
<body>
    ...
    if(mysqli_num_rows($result) == 0){ ?><br/><br/><br/>
        <h4 class="alert alert-danger text-center">Add products to cart first. Goto <a href="home.php">Home</a> page.</h4>
   <?php }else{
    $total = 0;
    ?>
            ...
            <table class="table table-bordered">
                <tbody>
					...
					<tr>
                        ...
                        <td>
                            <a href="home.php" class="btn btn-primary " name="addmore">Add more</a>
